...
function HistoryDetailsScreen(props) {
            ...
            >
                ...
                <View style={{ paddingBottom: 30, justifyContent: 'flex-start', flexDirection: 'column' }}>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingBottom: 15 }}>
                        ...
                        <Text style={{ fontFamily: 'Montserrat-Bold', color: 'white', paddingRight: 20, fontSize: 20, paddingRight: 20 }}>Package Delivered</Text>
                    </View>
                </View>
            </View>
